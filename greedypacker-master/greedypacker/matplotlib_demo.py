...
def get_vertices(i: Item, margin: int = 0.0) -> List[int]:
    corners = [(i.x, i.y), 
            (i.x+i.width, i.y),
...
if __name__ == '__main__':
    ...
    guillotine = [Item(2,3), Item(2,2), Item(2,1), Item(2,3), Item(2,2), Item(3,2)]
    maximal = [Item(2,3), Item(3,3), Item(4,1), Item(2,3), Item(2,2), Item(1,2)]
    shelf = [Item(2,3), Item(2,2), Item(2,1), Item(3,2), Item(1,1), Item(6,3), Item(3,2), Item(3,2), Item(4,2), Item(4,1)]
    skyline = [Item(3,2), Item(2,1), Item(4,2), Item(1,3), Item(4,2), Item(2,3), Item(2, 2)]
    M.add_items(*maximal)
    M.execute()
    print(M.bins)
